...
"""
python scripts/model_merger.py --local_dir /local_data/sunyubo/Sleuth/src/RS-GRPO/checkpoints/easy_r1/EVisRAG/global_step_670/actor --hf_upload_path /local_data/sunyubo/Sleuth/saves/Qwen7B-SFT
"""
